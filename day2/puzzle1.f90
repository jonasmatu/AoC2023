...
contains
  ...
  function get_puzzle_number(line) result(res)
    ...
    if (red > 12) then
       res = 0
       print *, "ID = ", id, "!invalid!","max: red = ", red, " blue = ", blue, " green = ", green
    else if (green > 13) then
       res = 0
       print *, "ID = ", id, "!invalid!","max: red = ", red, " blue = ", blue, " green = ", green
    else if (blue > 14) then
       res = 0
       print *, "ID = ", id, "!invalid!","max: red = ", red, " blue = ", blue, " green = ", green
    end if

    if (res /= 0) print *, "ID = ", id,"!valid!", "max: red = ", red, " blue = ", blue, " green = ", green
